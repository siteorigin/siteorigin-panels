...
class SiteOrigin_Panels_Admin {
	...
	function __construct() {
		...
		add_action( 'plugin_action_links_siteorigin-panels/siteorigin-panels.php', array( $this, 'plugin_action_links' ) );
		...
		add_action( 'admin_print_scripts-appearance_page_so_panels_home_page', array( $this, 'enqueue_admin_scripts' ) );
	 ...
	 * @return bool
	 */
	static function display_teaser(){
		return
