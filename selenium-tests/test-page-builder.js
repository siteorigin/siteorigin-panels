...
test.describe('Page Builder', function() {
    ...
    test.before(function () {
        ...
        driver.get('http://local.wordpress.dev/wp-login.php');
    ...
    test.xit('should create the Page Builder tab.', function () {
        driver.get('http://local.wordpress.dev/wp-admin/post-new.php?post_type=page');
        driver.wait(until.titleContains('Add New Page'), 3000);
        driver.wait(until.elementLocated(By.id('content-panels')), 3000);
    });

    test.xit('should successfully add a row.', function () {
        driver.get('http://local.wordpress.dev/wp-admin/post-new.php?post_type=page');
        driver.wait(until.elementLocated(By.id('content-panels')), 3000);
        driver.findElement(By.id('content-panels')).click();
        driver.wait(until.elementLocated(By.className('so-row-add')), 3000);
    ...
    test.xit('should successfully edit a row.', function () {
        driver.get('http://local.wordpress.dev/wp-admin/post.php?post=410&action=edit');
