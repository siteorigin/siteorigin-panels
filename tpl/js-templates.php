	...
	<div class="siteorigin-panels-builder">
		...
		<div class="so-builder-toolbar">
			...
			<?php if( SiteOrigin_Panels::display_premium_teaser() ) : ?>
				<a class="so-tool-button so-learn" title="<?php echo esc_attr_e( 'Page Builder Addons', 'siteorigin-panels' ) ?>" href="<?php echo esc_url( SiteOrigin_Panels::premium_url() ) ?>" style="margin-left: 10px;" target="_blank" rel="noopener noreferrer">
