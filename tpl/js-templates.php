	...
	<div class="siteorigin-panels-builder">
		...
		<div class="so-builder-toolbar">
			...
			<?php if( siteorigin_panels_display_premium_teaser() ) : ?>
				<a class="so-tool-button so-siteorigin-premium" title="<?php esc_attr_e( 'Contribute to Page Builder', 'siteorigin-panels' ) ?>" href="<?php echo esc_url( 'https://siteorigin.com/downloads/contribution/' ) ?>" target="_blank">
					<span class="so-panels-icon so-panels-icon-plus"></span>
					<span class="so-button-text"><?php esc_html_e('Contribute', 'siteorigin-panels') ?></span>
				</a>
			<?php endif; ?>
