...
class SiteOrigin_Color {
	...
	public static function hex2rgb( $hex ) {
		...
		foreach ( $rgb as $i => $p ) {
			$rgb[$i] = self::maxmin( round( $p ), 0, 255 );
		}
...
class SiteOrigin_Color_Object extends SiteOrigin_Color {
	...
	public function __construct( $color, $type = self::COLOR_HEX ) {
